...
from .views import custom_logout_view,register,success_view,login_view,fleet_manager_home_view,driver_home_view,introduction_to_ev,dataset,distribution,relationship,vehicle_status,prediction_view,relationship_view,home_view,predict_range,predict_electric_range,relationship_analysis
